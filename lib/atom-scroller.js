...
(function (AtomScroller) {
    ...
    function getElements(editorView) {
        return {
            view: editorView.element.querySelector(".scroll-view"),
    ...
    function patchEditor(editorView) {
        ...
        Array.prototype.forEach.call(scrollbars, function (bar) {
        ...
        AtomScroller.subscriptions.push(editorView.editor.onDidChangeScrollTop(function (top) {
            return view.scrollTop = top;
        }));
        AtomScroller.subscriptions.push(editorView.editor.onDidChangeScrollLeft(function (left) {
...
exports.activate = function (state) {
    AtomScroller.subscriptions.push(atom.workspaceView.eachEditorView(function (editorView) {
        return AtomScroller.patchEditor(editorView);
    }));
};

exports.deactivate = function () {
    atom.workspaceView.getEditorViews().forEach(function (editorView) {
        return AtomScroller.depatchEditor(editorView);
    });
    console.log(AtomScroller.subscriptions);
